...
SELECT COUNT(o.customer_id) as orderCount, c.company_name as customer
...
SELECT COUNT(o.ship_city) as orderCount, c.city as city
FROM orders o JOIN customers c
ON o.customer_id = c.customer_id
GROUP BY c.city
ORDER BY c.city
...
*** USED TO CHECK FOR VALID QUERY ***
SELECT o.order_id, c.*
FROM customers c LEFT JOIN orders o
ON o.customer_id = c.customer_id
WHERE o.order_id IS null *** used IS NOT also ***
ORDER BY o.order_id
...
*** queries to add and check ***
INSERT INTO accounts(name, budget)
VALUES ('Jon Scott', '90000')
